    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-700 mb-6">
          ...
          l'obiettivo di approfondire le tecnologie web moderne come React, API,
        ...
        <table className="min-w-full table-auto border-collapse border border-gray-300">
          <thead>
            <tr>
              <th className="px-4 py-2 text-left font-bold text-red-800 border-b">
                NOME
              </th>
              <th className="px-4 py-2 text-left font-bold text-red-800 border-b">
                GITHUB
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc pl-6 space-y-2 text-lg text-gray-700">
          ...
          <li>
            Anteprima del profilo di ciascun Pokémon, con dettagli come abilità,
            evoluzioni, statistiche, e altro.
          </li>
          <li>
          ...
          <li>
            Visualizzazione del profilo dell'allenatore, con i Pokémon catturati
            e preferiti.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-700">
          ...
          <p>
            Tutti i contenuti sono utilizzati per scopi educativi e di sviluppo.
            Non ci sono intenti commerciali dietro questa applicazione.
          </p>
        </p>
        <br></br>
        <p className="text-lg text-gray-700">
