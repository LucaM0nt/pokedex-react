...
export default function Footer() {
  return (
    <footer className='fixed bottom-0 left-0 right-0 bg-primary bg-opacity-100 z-40'>
      <div className='max-w-6xl mx-auto rounded-t-xl py-6 px-4'>
        ...
        <hr className='w-2/3 mx-auto border-gray-300 my-4' />
